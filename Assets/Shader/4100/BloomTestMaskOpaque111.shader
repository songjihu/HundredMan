Shader "HundredTalentsProgram/4100Bloom/MyPBR111"

{
    Properties
    {
        ...
        _BloomFator("BloomFator", Range(0.0, 1)) = 0
...
//================== PBR  ============================================== //
                ...
                float4 BaseColorA = tex2D(_BaseColorTex,uv);
...
//================== Indirect Light  ============================================== //
                ...
                //FinalColor.a = BaseColorA.a;
                FinalColor.a = _BloomFator;
